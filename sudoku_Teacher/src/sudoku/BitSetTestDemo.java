...
public class BitSetTestDemo {
	...
	public static void main(String[] args) {
		...
		/*
		 * Ein BitSet ist nur so lang wie das letzte gesetzte Bit 
		 * zumindest scheint das für die forEach Konstruktion zu gelten 
		 */
		// for (BitSet aktBS : bis) {
		// for (int j = 0; j < aktBS.length(); j++) {
		// if (aktBS.get(j))
		// System.out.print("1 ");
		// else {
		// System.out.print("0 ");
		...
		// System.out.println();
		// }
		// System.out.println(bis[1].get(10));
	}
}